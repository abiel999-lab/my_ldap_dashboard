...
class ImportApplyPlanService
{
    ...
    private function normalizeObjectClassesForApplyPlan(mixed $value): array
    {
        return app(ImportObjectClassService::class)->normalizeObjectClasses(
            $value,
            app(ImportObjectClassService::class)->defaultUserObjectClasses()
        );
    }

    private function appendObjectClassLdifLines(array &$lines, mixed $value): void
    {
        foreach ($this->normalizeObjectClassesForApplyPlan($value) as $objectClass) {
