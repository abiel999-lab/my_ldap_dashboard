...
class LdapServerResource extends Resource
{
        ...
        return $schema
            ->components([
                ...
                Section::make('Provisioning')
                    ->description('Untuk tahap pertama sistem generate command/manifest dulu, deployment bisa dijalankan manual.')
                    ->schema([
                        Grid::make(3)->schema([
    ...
    public static function table(Table $table): Table
    {
        return $table
            ...
            ->columns([
                ...
                IconColumn::make('is_registered_connection')->label('Registered')->boolean(),
    ...
    public static function getPages(): array
    {
        return [
            ...
            'create' => Pages\CreateLdapServer::route('/create'),
            'view' => Pages\ViewLdapServer::route('/{record}'),
            'edit' => Pages\EditLdapServer::route('/{record}/edit'),
        ];
    }
}
