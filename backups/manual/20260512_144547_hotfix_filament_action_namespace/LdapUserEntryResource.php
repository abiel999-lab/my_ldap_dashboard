    ...
    public static function canCreate(): bool
    {
        return false
            ->actions([
                ...
                \Filament\Tables\Actions\Action::make('syncFromTable')
                    ->label('Sync')
                ...
                \Filament\Tables\Actions\Action::make('deleteFromLdap')
                    ->label('Delete LDAP')
            ...
            ->bulkActions([
                \Filament\Tables\Actions\BulkAction::make('bulkSyncUsers')
                ...
                \Filament\Tables\Actions\BulkAction::make('bulkMoveOu')
                ...
                \Filament\Tables\Actions\BulkAction::make('bulkDeleteFromLdap')
        ...
        return $table
            ...
            ->actions([
                ...
                \Filament\Tables\Actions\Action::make('syncFromTable')
                    ...
                    ->action(function ($record): void {
                        $execution = CommandExecution::query()->create([
                            'command_type' => 'ldap_user_sync_queued',
                            'status' => 'queued',
                        ...
                        SyncUsersBatchJob::dispatch([$record->id], $execution->id);
                ...
                \Filament\Tables\Actions\Action::make('deleteFromLdap')
                    ...
                    ->action(function ($record): void {
                        $execution = CommandExecution::query()->create([
                            'command_type' => 'ldap_user_delete_queued',
                            'status' => 'queued',
                            'command' => 'queued job: BulkDeleteUsersFromLdapJob',
                            'environment_context' => [
                        ...
                        BulkDeleteUsersFromLdapJob::dispatch([$record->id], $execution->id);
                ...
                \Filament\Tables\Actions\BulkActionGroup::make([
                    \Filament\Tables\Actions\BulkAction::make('bulkSyncUsers')
                        ...
                        ->action(function ($records): void {
                            ...
                            $execution = CommandExecution::query()->create([
                                'command_type' => 'ldap_users_bulk_sync_queued',
                                'status' => 'queued',
                                'command' => 'queued job: SyncUsersBatchJob',
                                'environment_context' => [
                    ...
                    \Filament\Tables\Actions\BulkAction::make('bulkMoveOu')
                        ...
                        ->action(function ($records, array $data): void {
                            $ids = $records->pluck('id')->values()->all();
                            $newParentDn = (string) ($data['new_parent_dn'] ?? '');

                            $execution = CommandExecution::query()->create([
                                'command_type' => 'ldap_users_bulk_move_ou_queued',
                                'status' => 'queued',
                                'command' => 'queued job: BulkMoveUsersToOuJob',
                                'environment_context' => [
                            ...
                            BulkMoveUsersToOuJob::dispatch($ids, $newParentDn, $execution->id);
                    ...
                    \Filament\Tables\Actions\BulkAction::make('bulkDeleteFromLdap')
                        ...
                        ->action(function ($records): void {
                            ...
                            $execution = CommandExecution::query()->create([
                                'command_type' => 'ldap_users_bulk_delete_queued',
                                'status' => 'queued',
                                'command' => 'queued job: BulkDeleteUsersFromLdapJob',
                                'environment_context' => [
                            ...
                            BulkDeleteUsersFromLdapJob::dispatch($ids, $execution->id);
