...
class LdapCrudOperationResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Antar LDAP';

    protected static ?string $modelLabel = 'Antar LDAP Operation';

    protected static ?string $pluralModelLabel = 'Antar LDAP';
