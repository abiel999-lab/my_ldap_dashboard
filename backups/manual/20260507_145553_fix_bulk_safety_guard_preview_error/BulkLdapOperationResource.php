        ...
        return $table
            ...
            ->recordActions([
                ...
                Action::make('queueApply')
                    ...
                    ->modalDescription('This will run the selected bulk operation through Laravel Queue. Create adds missing users. Delete removes matching test users. Already completed targets are marked already_applied.')
