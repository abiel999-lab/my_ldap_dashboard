        ...
        return $schema
            ->state([
                ...
                'object_classes' => collect($objectClasses)
                    ->map(fn ($item): array => ['name' => (string) $item])
                    ->values()
                    ->all(),
                        ...
                        Tab::make('Directory Attributes')
                            ...
                            ->schema([
                                Section::make('Directory Attributes')
                                    ->description('Normal LDAP attributes. Attribute-level edit tetap difokuskan di Users untuk user object.')
                                    ->schema([
                                                ...
                                                Grid::make(4)
                                                    ->schema([
                                                        ...
                                                        TextEntry::make('values')
                                                            ->label('Values')
                                                            ->formatStateUsing(fn ($state): string => DirectoryObjectManagerResource::valuesText((array) $state))
                                                            ->copyable()
                                                            ->columnSpanFull(),
                                                    ]),
                                            ]),
