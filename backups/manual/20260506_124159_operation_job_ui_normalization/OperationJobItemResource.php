            ...
            ->components([
                Section::make('Item')
                    ->schema([
                        ...
                        TextEntry::make('target_identifier')->label('Target Identifier')->placeholder('N/A'),
        ...
        return $table
            ...
            ->columns(array_values(array_filter([
                ...
                self::hasColumn('operation_job_items', 'target_identifier')
                    ? TextColumn::make('target_identifier')->label('Target')->searchable()->limit(45)
                    : null,
                ...
                self::hasColumn('operation_job_items', 'error_message')
                    ? TextColumn::make('error_message')->label('Error')->limit(70)->placeholder('No error')
                    : null,
