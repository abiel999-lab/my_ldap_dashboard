            ...
            ->recordActions([
                Action::make('preview')
                    ...
                    ->action(function (BulkLdapOperation $record): void {
                        $result = app(BulkLdapUserOperationService::class)->previewCreateTestUsers($record);
                ...
                Action::make('queueApply')
                    ...
                    ->color('success')
                    ->visible(fn (BulkLdapOperation $record): bool => in_array($record->status, ['previewed', 'partial_success', 'failed'], true))
                    ->requiresConfirmation()
                    ...
                    ->action(function (BulkLdapOperation $record): void {
                        $result = app(BulkLdapUserOperationService::class)->queueApply($record, false);
                ...
                Action::make('retryFailed')
                    ...
                    ->color('warning')
                    ->visible(fn (BulkLdapOperation $record): bool => $record->failed_items > 0 || in_array($record->status, ['partial_success', 'failed'], true))
                    ->requiresConfirmation()
                    ...
                    ->action(function (BulkLdapOperation $record): void {
                        $result = app(BulkLdapUserOperationService::class)->queueApply($record, true);
