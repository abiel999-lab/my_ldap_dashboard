    ...
    protected function getHeaderActions(): array
    {
        return [
            ...
            Action::make('queueApply')
                ...
                ->modalDescription('This creates missing users through Laravel Queue in the background. Existing users are skipped as already_applied. Check Operation Jobs, Operation Job Logs, Command Executions, and Bulk LDAP Items.')
