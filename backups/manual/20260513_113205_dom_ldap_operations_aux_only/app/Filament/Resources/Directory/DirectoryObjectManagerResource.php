...
class DirectoryObjectManagerResource extends Resource
{
            ...
            ->actions([
                ActionGroup::make([
                    Action::make('openDetail')
                        ->label(fn ($record): string => static::isUserObject($record) ? 'Open User Page' : 'View Object Detail')
    ...
    public static function queueSyncObjects(array $data): void
    {
        try {
            ...
            SafeCommandExecutionLogger::createFailed('ldap_directory_objects_sync_dispatch_failed', $e->getMessage(), $data);
