                ...
                Section::make('Import File')
                    ->schema([
                        ...
                        Select::make('ldap_connection_id')
                            ...
                            ->preload()
                            ->nullable()
                            ->helperText('If empty, the import preview still works. Apply stage will require a target connection.'),
                        ...
                        FileUpload::make('file_path')
                            ...
                            ->required()
                            ->helperText('Foundation supports CSV, JSON, and LDIF preview. No LDAP data will be changed.'),
