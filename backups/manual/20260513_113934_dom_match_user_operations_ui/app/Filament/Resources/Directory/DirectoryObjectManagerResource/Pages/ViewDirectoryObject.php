        ...
        return [
            ...
            ActionGroup::make([
                ...
                Action::make('addObjectClass')
                    ->label('Add Auxiliary ObjectClass')
                    ...
                    ->form([
                        ...
                        KeyValue::make('must_attributes')
                            ...
                            ->keyLabel('Attribute')
                            ->valueLabel('Value')
                            ->helperText('Hanya AUXILIARY objectClass yang bisa ditambahkan. Isi MUST attribute jika schema membutuhkannya.'),
                    ])
                    ->action(fn (array $data) => $this->queueMutation('add_objectclass', $data)),

                Action::make('removeObjectClass')
                    ->label('Remove Auxiliary ObjectClass')
                    ...
                    ->form([
                        ...
                        TagsInput::make('remove_attributes')
                            ...
                            ->helperText('Hanya AUXILIARY objectClass yang bisa dihapus. Structural objectClass dan top bersifat read-only.'),
                    ])
